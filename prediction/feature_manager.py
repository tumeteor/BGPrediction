...
class FeatureManager:
    ...
    def fixedModel(self, ie, bz, carb, il_case, t):
        '''
        ...
        fixedModelPredictionFeature = Feature("fixedModelPrediction",bzc)
        self.contextFeatureGroup.addFeature(fixedModelPredictionFeature)
